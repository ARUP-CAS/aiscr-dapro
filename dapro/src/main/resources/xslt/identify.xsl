  ...
  <xsl:template name="identify">
    ...
    <description>
      <oai_dc:dc xmlns:oai_dc="http://www.openarchives.org/OAI/2.0/oai_dc/" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.openarchives.org/OAI/2.0/oai_dc/ http://www.openarchives.org/OAI/2.0/oai_dc.xsd">
        ...
        <xsl:element name="dc:description">http://www.archeologickamapa.cz/downloads/AMCR_diagram_cs.jpg</xsl:element>
        <xsl:element name="dc:description">http://www.archeologickamapa.cz/downloads/AMCR_diagram_en.jpg</xsl:element>
      </oai_dc:dc>
    </description>
  </xsl:template>
